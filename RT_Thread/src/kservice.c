...
//    rt_kprintf("                       =W%%Q                      \n");
//    rt_kprintf("                        =W%%M  _r'_:.             \n");
//    rt_kprintf("                        (%W%WwXQW#hQ=             \n");
//    rt_kprintf("               .:~'r942Bh%W%m;`.                  \n");
//    rt_kprintf("              `L|||poPW%WW%W_ 'c73333;'`          \n");
//    rt_kprintf("                  `vBWWPZ%%W_   ~x)m#W%%UP=       \n");
//    rt_kprintf("               `I&WhP'. =W%X''r==-   _<0%%%Ur.    \n");
//    rt_kprintf("           _=KObp1=. .=<5W%N$Q%%%%Q=    :v[W%0-   \n");
//    rt_kprintf("      `=<K$JZe'.  ;e3wVbKv'<V%%&4r=`       .''.   \n");
//    rt_kprintf("   `le(Pa'_.             -nWW[=                   \n");
//    rt_kprintf("    _.                '=3W%%fvL}///u/A#WJ}!_      \n");
//    rt_kprintf("            .'~rvjX/n6/29vxjW%j'''''''aGp#W=      \n");
//    rt_kprintf("       _3/BDWh$p&/e;..      |%f                   \n");
//    rt_kprintf("       ._`'=;.              $%%'                  \n");
//    rt_kprintf("                            M%W~                  \n");
//    rt_kprintf("                          _X%%e                   \n");
//    rt_kprintf("                        _vW%%M_                   \n");
