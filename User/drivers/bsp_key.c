...
#define KEY_ENSURE_PIN	    GPIO_Pin_14 //A14
#define KEY_CANCEL_PIN	    GPIO_Pin_10 //C10
#define KEY_UP_PIN	        GPIO_Pin_13 //A13
#define KEY_DOWN_PIN	    GPIO_Pin_15 //A15
...
void key_init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(KEY_RCCA|KEY_RCCC, ENABLE);
 
  GPIO_InitStructure.GPIO_Pin = KEY_ENSURE_PIN|KEY_UP_PIN|KEY_DOWN_PIN; 
...
void key_scan(void)
{
    ...
    t_key_code = (GPIO_ReadInputData(KEY_PORTA) & KEY_OTHER)|(GPIO_ReadInputData(GPIOC) & GPIO_Pin_10);
